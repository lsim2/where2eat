...
//////// cards adding and removing restaurant or like ranking considerably
// reduced
...
// double[] rockLoc = { 41.8251002, -71.4028338 };
// List<String> fT = new ArrayList<String>();
// Answer testAns = new Answer("1", cuisine, fT, restrictions, 1, rockLoc,
// 6000);
//
// List<Answer> answers = new ArrayList<Answer>();
// answers.add(testAns);
...
// }
// }
// >>>>>>> 1611b9b1f47f281cecaac3f43a30fa51db76a23c
