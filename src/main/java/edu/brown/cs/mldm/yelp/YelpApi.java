...
public class YelpApi {
	...
	public Set<Restaurant> getRestaurantSet(Answer answer) {
		...
		//String url = "term=" + terms + "&categories=" + categories + "&latitude=" + coordinates[0] + "&longitude=" + coordinates[1] + "&radius=" + radius + "&price="+price;		                        
	...
	public Set<Restaurant> makeRequest(String requestURL)  {
		 ...
		 Set<Restaurant> results = new HashSet<>();
	        Request request2 = new Builder()
	                .url("https://api.yelp.com/v3/businesses/search?" + requestURL + "&limit=" + NORMAL_LIMIT + "&sort_by=" + SORT)
	                .get()
